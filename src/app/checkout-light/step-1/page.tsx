...
export default function Step1LightPage() {
  ...
  return (
    <div className="relative min-h-screen font-sans bg-page">
      ...
      <div className="relative w-full -mt-[25px]" style={{ aspectRatio: "9/7" }}>
        ...
        />
        <div className="absolute inset-0 pointer-events-none" style={{ background: "var(--c-image-overlay)" }} />
      </div>
      ...
      <BottomBar
        ...
        onAddToCart={() => router.push("/checkout-light/step-2")}
      />
    </div>
  )
}
